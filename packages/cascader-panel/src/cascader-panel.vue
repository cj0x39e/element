      ...
      if (config.lazy && isEmpty(options)) {
        ...
        if (multiple) {
          ...
          this.$nextTick(() => {
            ...
            const doCheck = () => {
              const nodes = checkedValue.map(v => this.getNodeByValue(v[v.length - 1])).filter(v => v !== null);
              nodes.forEach(n => {
                n.doCheck(true);
              });
            ...
            const hasValue = () => {
              ...
              if (this.loadMultipleIndex === this.checkedValue[this.loadCount].length) {
              ...
              if (this.getNodeByValue(this.checkedValue[this.loadCount][this.loadMultipleIndex])) {
                hasValue();
              } else {
                lazyData(this.getNodeByValue(this.checkedValue[this.loadCount][this.loadMultipleIndex - 1]), () => {
                  hasValue();
                });
              }
            };
